  ...
  return (
    <section className="cv-section">
      ...
      <div className="cv-grid">
        {/* Left Column: Education and Technical Proficiencies */}
        <div>
          {/* Education */}
        ...
        <div className="cv-block">
          ...
          <div className="publications">
            <div className="publication">
              <p>
                West-Roberts, J.A., et al. (2024). "Diverse Genomic Embedding Benchmark for functional evaluation
            ...
            <div className="publication">
              <p>
                Al-Shayeb, B., et al. (2021). "Borgs are Giant Extrachromosomal Elements with the Potential to Expand
                Metabolic Capacity". Nature.
              </p>
            </div>
          </div>
        </div>
